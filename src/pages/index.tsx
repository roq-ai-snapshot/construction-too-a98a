  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless tool rentals with Construction Tool Rental v1 - Your one-stop solution for accessing construction tools from multiple outlets anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless tool rentals with Construction Tool Rental v1 - Your one-stop solution for accessing construction tools from multiple outlets anytime, anywhere.`}
            </Text>
            <Box
