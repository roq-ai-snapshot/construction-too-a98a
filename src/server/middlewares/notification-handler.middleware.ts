...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create.create': { roles: ['owner', 'admin'], key: 'order', tenantPath: [], userPath: [] },
  'payment.receive.update': { roles: ['owner', 'admin'], key: 'payment', tenantPath: [], userPath: [] },
  'feedback.create.create': { roles: ['owner', 'admin'], key: 'feedback', tenantPath: [], userPath: [] },
};
